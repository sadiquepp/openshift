# Introduction
This doc will cover deployment of disconnected OpenShift using UPI in just three availability zones using an external manually managed load balancer for API and Ingress.
...
* Delete manifests that creates master nodes.
...
sed -i "s/subnet_id_az3/$SUBNET_ID_AZ3/g" control-plane-parameters.json

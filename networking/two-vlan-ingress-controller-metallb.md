...
graph TD
    subgraph "External Network"
        direction TB
        Internet["Internet (VLAN 10)"]
        Internal["Internal Network (VLAN 20)"]
    end
    ...
    subgraph "OpenShift Cluster"
        ...
        subgraph "Ingress Controller 1 (VLAN 10)"
            direction TB
            IC1_Pod1["Pod 1"]
            IC1_Pod2["Pod 2"]
        end

        subgraph "Ingress Controller 2 (VLAN 20)"
            direction TB
            IC2_Pod1["Pod 1"]
            IC2_Pod2["Pod 2"]
        end
        ...
        subgraph "Application Namespaces"
            direction TB
            NS1["Namespace 1 (VLAN 10)"]
            NS2["Namespace 2 (VLAN 20)"]
        end
    end
    ...
    classDef ingress fill:#e8f5e9,stroke:#2e7d32,stroke-width:2px;
    classDef app fill:#fce4ec,stroke:#880e4f,stroke-width:2px;

    class Internet,Internal internet,internal;
    class W1,W2 worker;
    class IC1_Pod1,IC1_Pod2,IC2_Pod1,IC2_Pod2 ingress;
    class NS1,NS2 app;
```

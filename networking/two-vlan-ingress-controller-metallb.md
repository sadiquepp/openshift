# Antigravity: OpenShift Dual-VLAN Ingress with MetalLB
...
⚖️ 3. MetalLB LoadBalancer Configuration
...
spec:
  ...
  nodeSelectors: [{matchLabels: {node-role.kubernetes.io/ingress: ""}}]
🛣️ 4. Ingress Controller Sharding
...
🛠️ 5. Post-Deployment Fixes (The "Trinity")
